...
<header role="banner" id="navbar" class="probootstrap-header">
    <div class="container">
        <a href="/gotThem" class="probootstrap-logo"><img src="resources/image/GotthemLogo.PNG" height="50" width="200" alt="Gotthem" style="margin-top:5px;"></a>
        <a href="#" class="probootstrap-burger-menu visible-xs" ><i>Menu</i></a>
        <div class="mobile-menu-overlay"></div>

        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            <li><a href="gotthemInfo.gt" class="nanumbarunpenr">GotThem 소개</a></li>
