...
width: 253px;
height: 34px;}
.fileBox .fileName {display:inline-block;width:172px;height:30px;padding-left:10px;margin-right:5px;line-height:1.42857143;border:1px solid #ccc;background-color:#fff;vertical-align:middle;border-radius: 4px;}
...
<body>
	...
	<div class="cover-container pb-5">
		<div class="cover-inner container">
					<form action="storeModi.st" method="POST"
						...
						<input type="hidden" name="mem_id" value="${memberInfo.mem_name}" />
	...
	<tr>
		<th nowrap>주소</th>
		<td><input type="text"
									class="form-control" name="mem_address1" value="${mem_address1}" required="" maxlength="50"/><br> <input
									type="text" class="form-control" name="mem_address2"
	...
	<tr>
		<th nowrap>코멘트</th>
		<td><textarea class="form-comment" name="sto_comment" style="height:100px;resize:none;
		overflow:visible;text-overflow:ellipsis;"
		 required="" maxlength="100">${memberInfo.sto_comment }</textarea></td>
	</tr>						
	<tr>
	<td nowrap colspan="2" align="right"><button class="btn btn-primary" type="submit">완료</button>
						<button class="btn btn-primary" onclick="history.go(-1)">취소</button></td></tr>
						</table>
