...
<body>
	...
	<div class="wrapper">
		<div class="landing-header"
			style="background-image: url('resources/mainTemplate/assets/paper_img/mainimage.jpg');">
				...
				<div class="motto">
					...
					<div class="col-sm-7">
						<div class="form-group">
							<input type="text" value="" placeholder="Inactive"
								class="form-control" />
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="col-md-4">
						<div class="team-player">
							<img src="../assets/paper_img/chet_faker_2.jpg"
								alt="Thumbnail Image" class="img-circle img-responsive">
							<h5>
								씨유 강남점 <br /> <small class="text-muted">서울</small>
							</h5>
							<p>
					...
					<div class="col-md-4">
						<div class="team-player">
							<img src="../assets/paper_img/flume.jpg" alt="Thumbnail Image"
								class="img-circle img-responsive">
							<h5>
								GS25 연남점 <br /> <small class="text-muted">서울</small>
							</h5>
							<p>
								You can write here details about one of your team members. You
								can give more details about what they do. Feel free to add some
					...
					<div class="col-md-4">
						<div class="team-player">
							<img src="../assets/paper_img/banks.jpg" alt="Thumbnail Image"
								class="img-circle img-circle img-responsive">
							<h5>
								세븐일레븐 서울대입구점 <br /> <small class="text-muted">서울</small>
							</h5>
							<p>
								You can write here details about one of your team members. You
								can give more details about what they do. Feel free to add some
					...
					<div class="container tim-container">
						<div class="row">
							...
							<div
								...
								<a href="storeIndex.st"
									class="btn btn-danger btn-fill btn-block btn-lg">APPLY</a>
							</div>
						</div>
					</div>
				</div>
...
<script src="resources/mainTemplate/bootstrap3/js/bootstrap.js"
