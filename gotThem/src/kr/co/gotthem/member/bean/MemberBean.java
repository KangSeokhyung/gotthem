...
public class MemberBean {
	...
	private int enabled;
	private String sto_permitstatus;
	...
	public String getSto_permitstatus() {
		return sto_permitstatus;
	}

	public void setSto_permitstatus(String sto_permitstatus) {
		this.sto_permitstatus = sto_permitstatus;
	}
	...
	public String toString() {
		return "MemberBean [mem_no=" + mem_no + ", mem_id=" + mem_id + ", mem_pw=" + mem_pw + ", mem_name=" + mem_name
				...
				+ ", sto_permitstatus=" + sto_permitstatus + "]";
	}
